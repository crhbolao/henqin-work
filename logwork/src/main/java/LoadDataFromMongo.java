...
public class LoadDataFromMongo {
     ...
     * 保存探针原始数据的文件路径
     */
    public File wifiSourceDataFile = new File("C:\\Users\\sssd\\Desktop\\横琴数据导出准备\\logdata\\wifiSourceData.csv");

    /**
     * 保存探针按天统计的结果
     */
    public File wifiDayCountFile = new File("C:\\Users\\sssd\\Desktop\\横琴数据导出准备\\logdata\\wifiDayCountFile.csv");
    ...
    public void readDataFromMongo() {
        ...
        // mongo 查询的时间段
        String startTime = new DateTime().minusDays(7).toString("yyyy-MM-dd HH:mm:ss");
